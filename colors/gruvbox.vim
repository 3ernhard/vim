...
call s:HL('GruvboxRedStatusline', s:sign_column, s:gb.red, s:bold)
call s:HL('GruvboxGreenStatusline', s:sign_column, s:gb.green, s:bold)
call s:HL('GruvboxYellowStatusline', s:sign_column, s:gb.yellow, s:bold)
call s:HL('GruvboxBlueStatusline', s:sign_column, s:gb.blue, s:bold)
call s:HL('GruvboxPurpleStatusline', s:sign_column, s:gb.purple, s:bold)
call s:HL('GruvboxAquaStatusline', s:sign_column, s:gb.aqua, s:bold)
call s:HL('GruvboxOrangeStatusline', s:sign_column, s:gb.orange, s:bold)
...
if has('gui_running')
  ...
  call s:HL('GruvboxRedUnderline', s:none, s:none, s:underline, s:gb.red)
  call s:HL('GruvboxGreenUnderline', s:none, s:none, s:underline, s:gb.green)
  call s:HL('GruvboxYellowUnderline', s:none, s:none, s:underline, s:gb.yellow)
  call s:HL('GruvboxBlueUnderline', s:none, s:none, s:underline, s:gb.blue)
  call s:HL('GruvboxPurpleUnderline', s:none, s:none, s:underline, s:gb.purple)
  call s:HL('GruvboxAquaUnderline', s:none, s:none, s:underline, s:gb.aqua)
  call s:HL('GruvboxOrangeUnderline', s:none, s:none, s:underline, s:gb.orange)
endif
...
hi! link ErrorStatusline GruvboxRedStatusline
hi! link WarningStatusline GruvboxYellowStatusline
hi! link InfoStatusline GruvboxBlueStatusline
